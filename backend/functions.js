...
const configuration = new Configuration({
    apiKey: "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"
  });
...
const diffChecker = async(preText, postText) => {
    const apiUrl = 'https://api.diffchecker.com/public/text?output_type=html&email=jamex2931@gmail.com';
    const requestData = {
        left: preText,
        right: postText,
        diff_level: 'word'
...
module.exports = {pdfToText, gptDeIdentify, diffChecker}
